---
name: odoo-hr
description: Use when the user asks about Odoo HR Expert topics such as Employee Management, Department Structure, Contracts in Odoo 19. Loads knowledge from skills/hr/.
---
