---
name: odoo-purchase
description: Use when the user asks about Odoo Purchase Expert topics such as RFQ & Purchase Order Management, Vendor Management, Purchase Pricelists & Discounts in Odoo 19. Loads knowledge from skills/purchase/.
---
