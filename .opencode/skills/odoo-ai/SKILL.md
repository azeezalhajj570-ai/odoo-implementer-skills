---
name: odoo-ai
description: Use when the user asks about Odoo AI Agent Expert topics such as AI Agent Configuration, LLM Provider Integration, AI Model Registry in Odoo 19. Loads knowledge from skills/ai/.
---
