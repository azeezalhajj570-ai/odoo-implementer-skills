---
name: odoo-security
description: Use when the user asks about Odoo Security Expert topics such as Access Rights, Record Rules, Field Permissions in Odoo 19. Loads knowledge from skills/security/.
---
