---
name: odoo-base
description: Use when the user asks about Odoo Platform Foundation topics such as Odoo ORM, Odoo Security, XML Views in Odoo 19. Loads knowledge from skills/base/.
---
