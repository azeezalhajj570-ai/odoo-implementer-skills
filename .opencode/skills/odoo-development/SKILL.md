...
description: Use when the user asks about Odoo Development Expert topics such as Module Structure, Model Development, XML Views in Odoo 19. Loads knowledge from skills/development/.
---
