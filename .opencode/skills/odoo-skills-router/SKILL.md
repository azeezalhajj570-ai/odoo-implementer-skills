---
name: odoo-skills-router
description: Use when the user asks about Odoo in general, wants to know which Odoo domain skill applies, or mentions a domain without a clear workflow skill invocation.
---

# Skill: odoo-skills-router

Route Odoo questions to the right domain-specific skill.
